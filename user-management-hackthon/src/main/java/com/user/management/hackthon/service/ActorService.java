...
public class ActorService {
	...
	public List<DoctorDTO> getDoctors() {
		...
		doctorsList.stream().forEach(doctor -> {
			...
			dto.setGender(UserContants._M.equalsIgnoreCase(doctor.getGender()) ? UserContants.MALE : UserContants.FEMALE);
			doctors.add(dto);
		});
	...
	public PatientDTO getPatientById(String patientId) {
		...
		patient.setGender(UserContants._M.equalsIgnoreCase(entityPatient.getGender()) ? UserContants.MALE : UserContants.FEMALE);
